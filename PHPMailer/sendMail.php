...
$mail->Host = "smtp.163.com"; // 您的企业邮箱域名									//smtp.qq.com
$mail->SMTPAuth = true; // 启用SMTP验证功能	
$mail->Username = "reggiecril@163.com"; // 邮箱用户名(请填写完整的email地址)		//QQ号码@qq.com
$mail->Password = "Cloud19961008"; // 邮箱密码											//QQ密码
$mail->Port=25;	
$mail->From = "reggiecril@163.com"; //邮件发送者email地址							//QQ号码@qq.com
$mail->FromName = "smtptester";														//显示的名字，可以随意定义
$toAddress ="reggiecril@163.com";														//发送到的邮件地址
